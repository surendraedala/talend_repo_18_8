...
package sfty_test.test_job_0_1;
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_bCVY0B1mEe2XqvokD8wXog", "0.1");
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_SFTY_TEST_test_job = new byte[0];
    static byte[] commonByteArray_SFTY_TEST_test_job = new byte[0];
				...
				public Boolean SLOTIsNullable(){
				    return true;
				}
				public Boolean SLOTIsKey(){
				    return false;
				}
				public Integer SLOTLength(){
				    return 2147483647;
				}
				public Integer SLOTPrecision(){
				    return 0;
				}
				public String SLOTDefault(){
				...
				public String SLOTOriginalDbColumnName(){
				...
				public Boolean GATEIsNullable(){
				    return true;
				}
				public Boolean GATEIsKey(){
				    return false;
				}
				public Integer GATELength(){
				    return 2147483647;
				}
				public Integer GATEPrecision(){
				    return 0;
				}
				public String GATEDefault(){
				
					return null;
				
				}
				public String GATEComment(){
				...
				public String GATEOriginalDbColumnName(){
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SFTY_TEST_test_job.length) {
				if(length < 1024 && commonByteArray_SFTY_TEST_test_job.length == 0) {
   					commonByteArray_SFTY_TEST_test_job = new byte[1024];
				} else {
   					commonByteArray_SFTY_TEST_test_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SFTY_TEST_test_job, 0, length);
			strReturn = new String(commonByteArray_SFTY_TEST_test_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SFTY_TEST_test_job, 0, length);
			strReturn = new String(commonByteArray_SFTY_TEST_test_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SFTY_TEST_test_job) {
...
out1Struct out1 = new out1Struct();
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"serial_id","S_CITY","E_CITY","VACATION","DISTANCE","FARE","S_INCOME","E_INCOME","S_POP","E_POP","SLOT","GATE",});        
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:gSNjIsAQ4HzEYz/+5zB8lZfvz2ee30Ekp9j93ZisxuR2NYzU").substring(0, 4) + "...");     
                        log4jParamters_tDBInput_1.append(" | ");
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:8yIVCPNOTeOlxdLsj3nw0gzOKia+elrzzRgmySv60xFMkDHU");
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.serial_id = '" + row3HashKey.serial_id + "'");
								} // G 071
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:9NgGhGpvz7Tl1H4uSYfwmfhdv+Y2Ku3K2vJQAyGZe1qtLsLB").substring(0, 4) + "...");     
                        log4jParamters_tDBInput_2.append(" | ");
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WihV5j5KoVGfjI+viueiwBBhFxYk0Hf1SdPdNcKtoXPzQvD9");
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:hwug0nFSMEV4G0435LEr4lVxm53HFgPEFj/8u4OIFHqVlckF").substring(0, 4) + "...");     
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"SELECT    \\\"airfares_3\\\".\\\"serial_id\\\",    \\\"airfares_3\\\".\\\"SLOT\\\",    \\\"airfares_3\\\".\\\"GATE\\\" FROM \\\"airfares_3\\\"\"");
                        log4jParamters_tDBInput_3.append(" | ");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("serial_id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("SLOT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("GATE")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_3", "\"airfares_3\"", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
			}
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:DGuTRRtDhzRYemmHPqt4Y/XtEqkwCelMIk1xnDwdx55od8qr");
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tDBInput_3","\"airfares_3\"","tPostgresqlInput","tAdvancedHash_row3","tAdvancedHash_row3","tAdvancedHash"
...
tHash_Lookup_row3.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row3",2,0,
			 			"tDBInput_3","\"airfares_3\"","tPostgresqlInput","tAdvancedHash_row3","tAdvancedHash_row3","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = test_job.class.getClassLoader().getResourceAsStream("sfty_test/test_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     180798 characters generated by Talend Cloud Data Management Platform 
 *     on the August 17, 2022 at 4:31:02 PM IST
 ************************************************************************************************/